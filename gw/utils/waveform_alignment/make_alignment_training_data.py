...
# nohup python make_alignment_training_data.py PHM 40 >nohup_PHM40.out &
# nohup python make_alignment_training_data.py P 40 >nohup_P40.out &
if __name__ == '__main__':
    ...
    save_folder = ''
    h5filename = save_folder + f'dtdphi_8D_q7a5M{Mtot}_IMREOB_{phy}.h5'
    # 1: 4s, 4096Hz
    # 2: 16s, 4096Hz, //3
    # 3: 32s, 8192Hz, //10
